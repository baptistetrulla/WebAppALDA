...
<head>
	...
	<title>Informations transaction - WebAppALDA</title>
...
<body>
	...
	<div class="container">
		...
		<div class="row">
			<button type="button" class="btn btn-success" onclick="validatePayment(${sale.id})">Confirmer la transaction</button>
		</div>
	</div>
