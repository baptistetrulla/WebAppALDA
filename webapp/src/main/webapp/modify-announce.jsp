...
<head>
	...
	<title>Modifier une annonce - WebAppALDA</title>
		...
		<form method="POST" id="create-announce-form" class="form-signin" action="/CreateAnnounceValidation">
			...
			<div class="form-group">
				...
				<div class="col-xs-6 col-sm-6 col-lg-7">
					<input type="text" value="${sale.price}" maxlength="250"
			...
			<div class="form-group">
				...
				<div class="col-xs-6 col-sm-6 col-lg-7">
					<input type="text" value="${sale.type}" maxlength="250"
			...
			<div class="form-group">
				...
				<div class="col-xs-6 col-sm-6 col-lg-7">
					<input type="text" value="${sale.surface}" maxlength="250"
			...
			<div class="form-group">
				...
				<div class="col-xs-6 col-sm-6 col-lg-7">
					<input type="text" value="${sale.address}" maxlength="250"
			...
			<div class="form-group">
				...
				<div class="col-xs-6 col-sm-6 col-lg-7">
					<input type="text" value="${sale.city}" maxlength="250"
			...
			<div class="form-group">
				...
				<div class="col-xs-6 col-sm-6 col-lg-7">
					<input type="text" value="${sale.description}" maxlength="10"
			...
			<div id="entry-left" class="col-xs-12 col-sm-12 col-md-6 col-lg-6 form-group">
	          <div class="entry-block thumbnail wall" style="height: 451px;">
	            ...
	            <div id="photoPreviewContainer1">
	            	<img src="./assets/${sale.photo1Path}.png" id="photoPreview1" width="200" />
	            </div>
			...
			<div id="entry-left" class="col-xs-12 col-sm-12 col-md-6 col-lg-6 form-group">
	          <div class="entry-block thumbnail wall" style="height: 451px;">
	            ...
	            <div id="photoPreviewContainer2">
	            	<img src="./assets/${sale.photo2Path}.png" id="photoPreview2" width="200" />
	            </div>
